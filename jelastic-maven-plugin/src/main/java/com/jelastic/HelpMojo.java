...
/**
 * Display help information on jelastic-maven-plugin.<br/>
 * Call <code>mvn jelastic:help -Ddetail=true -Dgoal=&lt;goal-name&gt;</code> to display parameter details.
 * @author
 * @version
 * @goal help
    ...
    extends AbstractMojo
{
    ...
    private static final String PLUGIN_HELP_PATH = "/META-INF/maven/com.jelastic/jelastic-maven-plugin/plugin-help.xml";

...
public class InitHttpClient implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
        ...
        e = driver.findElement(By.xpath("//span[@node-type='submitStates']"));
        e.click();
...
//        httpClient.startSession(new URL("http://weibo.com"));
        ...
        try {
        	...
        	httpMethod.setPath("/");
        	httpMethod.addRequestHeader("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.101 Safari/537.36");
			...
			if(!succ)
				...
				postMethod.addRequestHeader("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.101 Safari/537.36");

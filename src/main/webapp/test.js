!window.register_login_index && function () {
    ...
    STK.register("core.str.decodeHTML", function (a) {
        return function (a) {
            ...
            return a.replace(/&quot;/g, '"').replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&#39;/g, "'").replace(/&nbsp;/g, "鑱�").replace(/&#32;/g, " ").replace(/&amp;/g, "&")
        }
    });
    ...
    STK.register("core.util.swf", function (a) {
        function b(b, c) {
            ...
            if (b == null) throw "swf: [sURL] 閺堫亜鐣炬稊锟�";
            var e, f = [],
                g = [];
    ...
    STK.register("common.listener", function (a) {
        ...
        c.define = function (c, d) {
            if (b[c] != null) throw "common.listener.define: 棰戦亾宸茶鍗犵敤";
            b[c] = d;
            var e = {};
            e.register = function (d, e) {
                if (b[c] == null) throw "common.listener.define: 棰戦亾鏈畾涔�";
                a.listener.register(c, d, e)
            };
            e.fire = function (d, e) {
                if (b[c] == null) throw "commonlistener.define: 棰戦亾鏈畾涔�";
    ...
    STK.register("common.layer.emailAutocomplete", function (a) {
        var b = a.kit.extra.textareaUtils,
            ...
            e = {
                panel: ['<div node-type="layer" class="layer_menu_list" style="display:none;">', '<ul><li class="note">#L{璇烽€夋嫨閭绫诲瀷}</li></ul>', '<ul node-type="panel"></ul>', "</div>"].join(""),
    ...
    STK.register("common.form.ssoErrCode", function (a) {
        ...
        return {
            4038: '#L{鐧诲綍娆℃暟杩囦簬棰戠箒锛寎<a href="http://help.weibo.com/faq/q/85/12699#12699" target="_blank">#L{鏌ョ湅甯姪}</a>',
            4049: "#L{璇峰～鍐欓獙璇佺爜}",
            4010: '#L{甯愬彿灏氭湭婵€娲汇€倉<a target="_blank" href="http://weibo.com/signup/v5/resend?username=#{USERNAME}">#L{閲嶅彂婵€娲婚偖浠秨</a>',
            4090: "#L{姝ゅ笎鍙锋湭婵€娲伙紝璇风櫥褰曞師甯愬彿}",
            5024: "#L{璇峰～鍐欐纭殑寰浘鍔ㄦ€佺爜}",
            5025: "#L{鍔ㄦ€佺爜鏈夎锛岃閲嶆柊杈撳叆}",
            5: '#L{灏氭湭娉ㄥ唽寰崥锛寎<a href="http://weibo.com/logout.php?backurl=' + encodeURIComponent("http://weibo.com/signup/signup.php") + '"' + (b ? "" : ' target="_blank"') + ">#L{椹笂娉ㄥ唽}</a>",
            101: '#L{鐢ㄦ埛鍚嶆垨瀵嗙爜閿欒銆倉<a href="http://help.weibo.com/faq/q/85/12606#12606" target="_blank">#L{鏌ョ湅甯姪}</a>'
        }
    });
    STK.register("common.login.form", function (a) {
        var b = ["username", "password", "verifycode", "vsncode"],
            ...
            h = {
                CAPSLOCK: "#L{閿洏澶у啓閿佸畾宸叉墦寮€锛岃娉ㄦ剰}",
                ERRTIP: {
                ...
                MAIN: '<div node-type="username_box" class="info_list"><div class="inp username"><input autocomplete="off" maxlength="128" tabindex="1" node-type="username" name="username" type="text" class="W_input" action-type="text_copy" action-data="text=#L{閭/浼氬憳甯愬彿/鎵嬫満鍙穧" value="" /></div></div><div node-type="password_box" class="info_list"><div class="inp password"><input maxlength="24" tabindex="2" node-type="password" name="password" type="password" class="W_input" action-type="text_copy" value="" /><span class="enter_psw">#L{璇疯緭鍏ュ瘑鐮亇</span></div></div><div node-type="verifycode_box" class="info_list" style="display: none;"><div class="inp verify"><input maxlength="6" tabindex="3" node-type="verifycode" name="verifycode" type="text" class="W_input" value="" action-type="text_copy" action-data="text=#L{璇疯緭鍏ラ獙璇佺爜}" /><a class="code" href="javascript:void(0);" onclick="return false;"><img src="" node-type="verifycode_image" action-type="btn_change_verifycode" width="100" height="40"></a><a node-type="btn_change_verifycode" action-type="btn_change_verifycode" class="verify_refresh" href="javascript:void(0);" onclick="return false;">#L{鎹竴鎹</a></div></div><div node-type="vsncode_box" class="info_list" style="display: none;"><div class="inp wei_dun"><input maxlength="6" tabindex="4" node-type="vsncode" name="vsncode" type="text" class="W_input" action-type="text_copy" action-data="text=#L{璇疯緭鍏ュ井鐩惧姩鎬佺爜}" value="" /><a node-type="btn_vsncode_recover" href="http://account.weibo.com/forgot/vdun">#L{寰浘鎸傚け}</a></div></div><div class="info_list"><div class="inp automatic clearfix"><div class="right"><a suda-data="key=tblog_weibologin3&value=click_forgetpwd" target="_blank" node-type="btn_password_recover" href="https://login.sina.com.cn/getpass.html?entry=weibo">#L{蹇樿瀵嗙爜}</a></div><label action-type="customTip" action-data="content=#L{寤鸿鍦ㄧ綉鍚ф垨鍏叡鐢佃剳涓婂彇娑堣閫夐」銆倉" title="#L{寤鸿鍦ㄧ綉鍚ф垨鍏叡鐢佃剳涓婂彇娑堣閫夐」銆倉" for="login_form_savestate"><input tabindex="5" id="login_form_savestate" checked="checked" node-type="savestate" type="checkbox" class="W_checkbox" />#L{涓嬫鑷姩鐧诲綍}</label><a suda-data="key=tblog_weibologin3&value=click_help" action-type="customTip" action-data="content=#L{璁颁笉浣忕櫥褰曠姸鎬侊紝鎬庝箞鍔烇紵}" title="#L{璁颁笉浣忕櫥褰曠姸鎬侊紝鎬庝箞鍔烇紵}" target="_blank" class="icon_ask" href="http://help.weibo.com/faq/q/85/12524#12524"></a></div></div><div class="info_list no_reg"><a tabindex="6" suda-data="key=tblog_weibologin3&value=click_sign" node-type="submitBtn" action-type="btn_submit" class="W_btn_g" href="javascript:void(0)"><span node-type="submitStates">#L{鐧诲綍}</span></a><span class="no_reg_tip">#L{杩樻病鏈夊井鍗氾紵}<a suda-data="key=tblog_weibologin3&value=click_register" target="_blank" href="' + ($CONFIG && $CONFIG.register_url || "http://weibo.com/signup/signup.php") + '">#L{绔嬪嵆娉ㄥ唽锛亇</a></span>' + "</div>",
                SUBMIT: {
                    NORMAL: "#L{鐧诲綍}",
                    ONSUBMIT: '<b class="loading"></b>#L{鐧诲綍}'
                }
            }, i = {
        ...
        return function (f, l) {
            var n, o, p, q, r = {}, s, t, u, v = {
                    ...
                    bind: function () {
                        ...
                        n.add("btn_submit", "click", w.submit.active);
                        n.add("btn_change_verifycode", "click", w.resetVerifycode);
                        a.addEvent(p.username, "focus", w.stopCheckUsername);
                        a.addEvent(p.username, "blur", w.checkUsername);
                        a.addEvent(p.submitBtn, "focus", w.submit.focus);
                        a.addEvent(p.submitBtn, "blur", w.submit.blur);
                        a.foreach(o.ctls, function (b) {
                            b.pars.disabled || a.addEvent(b.node, "keydown", x.enter)
                        });
                        a.addEvent(p.submitBtn, "keydown", x.enter);
                        a.addEvent(p.password, "keypress", x.capslock);
                        a.custEvent.define(A, ["closeTip"]);
                        a.custEvent.add(A, "closeTip", w.errTip.hide);
                        d.register("verify.update", y.verify.update);
                        d.register("verify.failure", y.verify.failure);
                        d.register("verify.complete", y.verify.complete);
                        d.register("login.success", y.login.success);
                        d.register("login.failure", y.login.failure);
                        d.register("login.complete", y.login.complete);
                        d.register("logout.success", y.logout.success);
                        d.register("logout.failure", y.logout.failure);
                        d.register("logout.complete", y.logout.complete)
                    },
                    unbind: function () {
                        n.remove("btn_submit", "click", w.submit.active);
                        n.remove("btn_change_verifycode", "click", w.resetVerifycode);
                        n.destroy();
                        a.removeEvent(p.username, "focus", w.stopCheckUsername);
                        a.removeEvent(p.username, "blur", w.checkUsername);
                        a.removeEvent(p.submitBtn, "focus", w.submit.focus);
                        a.removeEvent(p.submitBtn, "blur", w.submit.blur);
                        a.foreach(o.ctls, function (b) {
                            a.removeEvent(b.node, "keydown", x.enter)
                        });
                        a.removeEvent(p.submitBtn, "keydown", x.enter);
                        a.removeEvent(p.password, "keypress", x.capslock);
                        a.custEvent.remove(A, "closeTip", w.errTip.hide);
                        a.custEvent.undefine(A, ["closeTip"]);
                        d.remove("verify.update", y.verify.update);
                        d.remove("verify.failure", y.verify.failure);
                        d.remove("verify.complete", y.verify.complete);
                        d.remove("login.success", y.login.success);
                        d.remove("login.failure", y.login.failure);
                        d.remove("login.complete", y.login.complete);
                        d.remove("logout.success", y.logout.success);
                        d.remove("logout.failure", y.logout.failure);
                        d.remove("logout.complete", y.logout.complete)
                    },
                    destroy: function () {
                        v.unbind();
                        w.destroy();
                        n = r = w = x = z = y = A = v = u = customTip = null
                    }
                }, w = {
                    init: function () {
                        q = a.common.setting.textCopy(f);
                        a.custEvent.define(q, ["focus", "blur", "keyup"]);
                        a.custEvent.add(q, "focus", w.textCopyHandle);
                        a.custEvent.add(q, "blur", w.textCopyHandle);
                    ...
                    changeExtra: function (a) {
                        for (var b in z) typeof a != "undefined" && a == b ? z[b].isVisible() ? z[b].reset() : z[b].enable() : z[b].isVisible() && z[b].disable()
                    },
                    ...
                    capslock: function (b) {
                        ...
                        var c = b.keyCode || b.which,
                            d = b.shiftKey || c == 16 || !1;
                        (c >= 65 && c <= 90 && !d || c >= 97 && c <= 122 && d) && w.errTip.show({
                                password: {
                                    msg: h.CAPSLOCK
                                }
                            })
                    ...
                    verifycode: {
                        enable: function () {
                            ...
                            z.verifycode.reset();
                            a.addEvent(p.verifycode, "keydown", x.enter)
                        },
                        disable: function () {
                            r.verifycode_auto && clearTimeout(r.verifycode_auto);
                            p.verifycode_box.style.display = "none";
                            o.ctls.verifycode.disabled(1);
                            a.removeEvent(p.verifycode, "keydown", x.enter)
                        },
                        reset: function () {
                            r.verifycode_auto && clearTimeout(r.verifycode_auto);
                            r.verifycode_auto = setTimeout(z.verifycode.reset, l.verifyCodeDelay);
                    ...
                    vsncode: {
                        enable: function () {
                            ...
                            z.vsncode.reset();
                            a.addEvent(p.vsncode, "keydown", x.enter)
                        },
                        disable: function () {
                            p.vsncode_box.style.display = "none";
                            o.ctls.vsncode.disabled(1);
                            a.removeEvent(p.vsncode, "keydown", x.enter)
                        },
                        reset: function () {
    ...
    STK.register("pl.login.qrcodelogin.source.main", function (a) {
        return function (b) {
            var c, d, e = a.kit.extra.language,
                f = !0,
                g = "http://i.sso.sina.com.cn/js/qrcode_login.js",
                h = {
                    scanSucc: e('<div node-type="outer" style="width:208px" class="layer_form_tips"><div class="bg"><div node-type="inner" class="content qrcode_tips"><a class="W_ico12 icon_close" node-type="close"></a><div class="W_tips empty clearfix"><p class="icon"><span class="icon_succ"></span></p><p class="txt">#L{鎵弿鎴愬姛}锛�<br>#L{鐐瑰嚮鎵嬫満涓婄殑纭鍗冲彲鐧诲綍}</p></div></div><div class="arrow arrow_tips"></div></div>'),
                    text: {
                        normal: e("#L{鏅€氱櫥褰晑"),
                        qrcode: e("#L{浜岀淮鐮佺櫥褰晑")
                    },
                    suda_track: {
                        normal: e('<a suda-uatrack="key=tblog_weibologin3&value=ordinary_login" href="javascript:void(0)">#L{鏅€氱櫥褰晑</a>'),
                        qrcode: e('<a suda-uatrack="key=tblog_weibologin3&value=code_login" href="javascript:void(0)">#L{浜岀淮鐮佺櫥褰晑</a>')
                    }
                }, i = function () {
                    SINA_QRCODE_LOGIN.getQRcode(function (a) {
                        if (a.retcode == "20000000") {
                            c.qrcode_src.src = a.data.image;
                            SINA_QRCODE_LOGIN.start()
                        }
                    })
                }, j = {
                    switchToQR: function () {
                        if (c.pl_login_normal.style.display != "none") {
                            a.addEvent(c.icon_tips, "mouseover", j.tips);
                            a.addEvent(c.icon_tips, "mouseout", j.tips);
                            c.login_normal.innerHTML = h.suda_track.normal;
                            c.login_qrcode.innerHTML = h.text.qrcode;
                            c.pl_login_normal.style.display = "none";
                            c.pl_login_qrcode.style.display = "";
                            a.preventDefault();
                            c.qrcode_src.src ? SINA_QRCODE_LOGIN.start() : i();
                            SINA_QRCODE_LOGIN.set({
                                entry: "sso",
                                domain: "weibo.com"
                            })
                        }
                    },
                    switchToNor: function () {
                        if (c.pl_login_qrcode.style.display != "none") {
                            SINA_QRCODE_LOGIN.cancel();
                            c.login_normal.innerHTML = h.text.normal;
                            c.login_qrcode.innerHTML = h.suda_track.qrcode;
                            c.pl_login_normal.style.display = "";
                            c.pl_login_qrcode.style.display = "none"
                        }
                    },
                    tips: function (a) {
                        if (a.type == "mouseover" || a.type == "onmouseover") c.icon_ask.style.display = "";
                        else if (a.type == "mouseout" || a.type == "onmouseout") c.icon_ask.style.display = "none"
                    },
                    close: function () {
                        d.hide()
                    },
                    register: function () {
                        SINA_QRCODE_LOGIN.register("qrcode_scanned", function (b) {
                            var e = d.getDom("outer"),
                                g = a.core.dom.position(c.pl_login_qrcode);
                            a.core.dom.setStyle(e, "top", g.t - 32 + "px");
                            a.core.dom.setStyle(e, "left", g.l - 10 + "px");
                            if (f) {
                        ...
                        SINA_QRCODE_LOGIN.register("qrcode_used", function (a) {
                            d && d.hide();
                            i()
                        });
                        ...
                        SINA_QRCODE_LOGIN.register("qrcode_exception", function (a) {
                            d && d.hide();
                            i()
                        });
                        SINA_QRCODE_LOGIN.register("login_success", function (a) {
                            d && d.hide();
                            window.location.reload()
                        });
                        SINA_QRCODE_LOGIN.register("login_failure", function (a) {
                            d && d.hide();
                            i()
                        })
                    }
                }, k = function () {
                    c = a.kit.dom.parseDOM(a.builder(b).list)
                }, l = function () {
                    a.addEvent(c.login_qrcode, "click", j.switchToQR);
                    a.addEvent(c.login_normal, "click", j.switchToNor)
                }, m = function () {
                    a.common.login.form(c.pl_login_normal);
                    d = a.ui.mod.layer(h.scanSucc);
                    var b = d.getDom("close");
                    a.addEvent(b, "click", j.close);
                    a.core.io.scriptLoader({
                        url: g,
                        timeout: 1e4,
                        onComplete: function () {
    ...
    STK.pageletM.register("pl.login.qrcodelogin.index", function (a) {
        return a.pl.login.qrcodelogin.source.main(a.E("pl_login_form"))
    });
